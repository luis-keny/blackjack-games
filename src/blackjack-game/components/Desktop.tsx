...
export const Desktop = ({ playerName, score, hasActions = false, onAdd, onReady, playerHand = [] }: DesktopProps) => {
  return (
    <article>
      ...
      <section className="player-desktop flex px-6 pl-38 py-4 bg-slate-800 rounded-md h-[352px] overflow-x-auto">
